...
(defcustom main-line-separator-style 'arrow14
...
arrow, which are all 18px high, except for chamfer14, arrow14, and slant14-right,
which are 14px high, and brace which is 19px high"
  :group 'main-line)
...
(defun slant14-right-xpm (color1 color2)
  "Return an XPM 14-pixel right slant."
  (create-image
   (format "/* XPM */
static char* slant14_right[] = {
\"7 14 3 1\",
\"@ c %s\",
\"# c %s\",
\"  c %s\",
...
\"@@@@@@@\"};"
           (or color2 "None")
           (or (and color1 color2 (interpolate color1 color2)) "None")
           (or color1 "None"))
   'xpm t :ascent 'center))
     ...
     (if arrow
         (propertize " " 'display
                     (cond
                      ...
                      ((eq main-line-separator-style 'slant14-right) (slant14-right-xpm color1 color2))
